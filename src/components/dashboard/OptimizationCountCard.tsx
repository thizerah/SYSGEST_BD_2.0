...
export function OptimizationCountCard({ serviceOrders }: OptimizationCountCardProps) {
  ...
  const technicianRanking = useMemo(() => {
    ...
    // Filtrar apenas OSs aplicáveis para otimização (somente finalizadas; backlog e canceladas ficam de fora)
                  ...
                  <Table className="w-full">
                    ...
                    <TableBody>
                      ...
                      <TableRow className={`${excessiveConsumption.atCorretiva.antenas.quantidadeExcedida > 0 ? 'bg-red-50' : 'bg-white'}`}>
                        ...
                        <TableCell className="text-center text-sm px-2 font-semibold">
                          {(() => {
                            const qtdPerm = Math.max(0, excessiveConsumption.atCorretiva.antenas.limitePermitido - excessiveConsumption.atCorretiva.antenas.volumeConsumo);
                            return qtdPerm;
                          })()}
                        </TableCell>
                        <TableCell className="text-center text-sm px-2">
                      ...
                      <TableRow className={`${excessiveConsumption.atCorretiva.lnbs.quantidadeExcedida > 0 ? 'bg-red-50' : 'bg-white'}`}>
                        ...
                        <TableCell className="text-center text-sm px-2 font-semibold">
                          {(() => {
                            const qtdPerm = Math.max(0, excessiveConsumption.atCorretiva.lnbs.limitePermitido - excessiveConsumption.atCorretiva.lnbs.volumeConsumo);
                            return qtdPerm;
                          })()}
                        </TableCell>
                        <TableCell className="text-center text-sm px-2">
                  ...
                  <Table className="w-full">
                    ...
                    <TableBody>
                      ...
                      <TableRow className={`${excessiveConsumption.upDown.antenas.quantidadeExcedida > 0 ? 'bg-orange-50' : 'bg-white'}`}>
                        ...
                        <TableCell className="text-center text-sm px-2 font-semibold">
                          {(() => {
                            const qtdPerm = Math.max(0, excessiveConsumption.upDown.antenas.limitePermitido - excessiveConsumption.upDown.antenas.volumeConsumo);
                            return qtdPerm;
                          })()}
                        </TableCell>
                        <TableCell className="text-center text-sm px-2">
                      ...
                      <TableRow className={`${excessiveConsumption.upDown.lnbs.quantidadeExcedida > 0 ? 'bg-orange-50' : 'bg-white'}`}>
                        ...
                        <TableCell className="text-center text-sm px-2 font-semibold">
                          {(() => {
                            const qtdPerm = Math.max(0, excessiveConsumption.upDown.lnbs.limitePermitido - excessiveConsumption.upDown.lnbs.volumeConsumo);
                            return qtdPerm;
                          })()}
                        </TableCell>
                        <TableCell className="text-center text-sm px-2">
